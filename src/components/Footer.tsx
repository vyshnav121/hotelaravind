                    ...
                    <div>
                        <div className="space-y-6">
                            <div className="flex items-center space-x-2">
                                <div className="p-1.5 bg-kerala-gold rounded-full text-kerala-green shrink-0">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-300">
                            <li className="flex items-start space-x-3">
                                <MapPin className="w-5 h-5 text-kerala-gold shrink-0 mt-0.5" />
                                <span>Main Road, <br />Sulthan Bathery, Wayanad</span>
                            </li>
                            <li className="flex items-start space-x-3">
                                <Phone className="w-5 h-5 text-kerala-gold shrink-0 mt-0.5" />
                                <span>+91 75111 11033</span>
                            </li>
                            <li className="flex items-start space-x-3 break-all">
                                <Mail className="w-5 h-5 text-kerala-gold shrink-0 mt-0.5" />
